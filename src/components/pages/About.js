    ...
    return (
        <main style={{ textAlign: 'center', padding: 10 }}>    
            ...
            <div className='d-flex justify-content-around'>
                <div className='aboutCard' style={{ maxWidth: '50vw', padding: 10 }}>
                    <p style={{ fontSize: 20 }}>
                ...
                <div className='picCard' style={{ maxWidth: '40vw' }}>
                    <img src={me} alt='Selfie of joshua jenkins' style={{ maxWidth: '40vw', maxHeight: 400 }}></img>
                    <img src={meDL} alt='me with dan and lynze cummins' style={{ maxWidth: '40vw' }}></img>
                </div>
            </div>
        </main>
    )
